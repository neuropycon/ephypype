...
# :download:`json <https://github.com/neuropycon/ephypype/blob/master/examples/params_tfr.json>`
# file and print it
#
...
import json  # noqa
import pprint  # noqa
data = json.load(open("params_tfr.json"))
pprint.pprint({'parameters': data})
ft_path = data['fieldtrip_path']
refmethod = data['refmethod']
