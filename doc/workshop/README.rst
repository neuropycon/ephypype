...
Alternativaly, you can create an enviroment by Anaconda and install the packages contained in :download:`requirements <./plot_ERPcore_preproc.ipynb>` file, e.g.
